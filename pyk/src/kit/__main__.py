...
def create_argument_parser() -> ArgumentParser:
    ...
    init_subparser.add_argument('kompiled_dir', type=dir_path, help='Path to *-kompiled directory.')
    init_subparser.add_argument('main_file', type=file_path, help='Path to main definition file.')
    init_subparser.add_argument('spec_file', type=file_path, help='Path to specification JSON file.')
...
def init(args):
    ...
    claim = _extract_claim_from_spec_file(args.spec_file)
    ...
    config = {
        'kompiledDir': relpath(args.kompiled_dir, kit_dir),
...
def cover(args):
    ...
    for k, v in subst.items():
        print(k + ' |-> ' + prover.kprove.prettyPrint(v))  # TODO enforce LoD ; Subst.pretty
...
def node(args):
    ...
    print(prover.kprove.prettyPrint(node.cterm.term))
